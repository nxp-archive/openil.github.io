...
$(function(){
    ...
    if(location_href.indexOf('news')>0){
        $(".menusm  li:nth-child(2)").addClass("active")
    }else if(location_href.indexOf('develop')>0){
        $(".menusm  li:nth-child(3)").addClass("active")
    }else if(location_href.indexOf('mailing')>0){
        $(".menusm  li:nth-child(4)").addClass("active")
    }else if(location_href.indexOf('contact')>0){
        $(".menusm  li:nth-child(5)").addClass("active")
    }else{
        $(".menusm  li:nth-child(1)").addClass("active")
    }
